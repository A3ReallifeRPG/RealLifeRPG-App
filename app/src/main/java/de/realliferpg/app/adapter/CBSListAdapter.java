...
public class CBSListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (cbsData.finished == 1){
            status = "</font><font color='" + convertView.getResources().getColor(R.color.colorMed) + "'>" + Resources.getSystem().getString(R.string.str_completed);
        } else if (cbsData.amount == cbsData.funding_required)
        {
            status = "</font><font color='" + convertView.getResources().getColor(R.color.colorRac) + "'>" + Resources.getSystem().getString(R.string.str_financed);
        } else {
            status = "</font><font color='" + convertView.getResources().getColor(R.color.colorRac) + "'>" + Resources.getSystem().getString(R.string.str_wip);
        }
