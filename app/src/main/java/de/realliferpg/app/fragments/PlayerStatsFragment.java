...
public class PlayerStatsFragment extends Fragment {
    ...
    public void showPlayerInfo(){
        ...
        TextView tvCash = view.findViewById(R.id.tv_player_cash);
        TextView tvBank = view.findViewById(R.id.tv_player_bank);

        TextView tvLevelCur = view.findViewById(R.id.tv_player_level_cur);
        TextView tvLevelNext = view.findViewById(R.id.tv_player_level_next);
        ProgressBar pbLevel = view.findViewById(R.id.pb_player_level);
